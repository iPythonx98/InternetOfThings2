// ======================================================================
// IoT2_labo_SPI.v generated from TopDesign.cysch
// 02/27/2018 at 17:56
...
module top ;
	...
	wire [0:0] tmpOE__SCLK1_net;
	wire [0:0] tmpFB_0__SCLK1_net;
	wire [0:0] tmpIO_0__SCLK1_net;
	wire [0:0] tmpINTERRUPT_0__SCLK1_net;
	electrical [0:0] tmpSIOVREF__SCLK1_net;

	cy_psoc3_pins_v1_10
		#(.id("ddbe5274-c6b9-4cf5-87b2-99ce93a7338f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SCLK1
		 (.oe(tmpOE__SCLK1_net),
		  .y({Net_149}),
		  .fb({tmpFB_0__SCLK1_net[0:0]}),
		  .io({tmpIO_0__SCLK1_net[0:0]}),
		  .siovref(tmpSIOVREF__SCLK1_net),
		  .interrupt({tmpINTERRUPT_0__SCLK1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SCLK1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5df5dd53-46d7-452d-8cff-9dca58db1a87"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1d2e2ac7-f8ea-4396-bf79-29e82ff091eb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("65ecfcfe-18e0-40a2-b6a7-3153dbaa63a0"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__MOSI1_net;
	wire [0:0] tmpFB_0__MOSI1_net;
	wire [0:0] tmpIO_0__MOSI1_net;
	wire [0:0] tmpINTERRUPT_0__MOSI1_net;
	electrical [0:0] tmpSIOVREF__MOSI1_net;

	cy_psoc3_pins_v1_10
		#(.id("5220f122-2ef8-4ed6-897f-509b3dd3acbc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MOSI1
		 (.oe(tmpOE__MOSI1_net),
		  .y({Net_153}),
		  .fb({tmpFB_0__MOSI1_net[0:0]}),
		  .io({tmpIO_0__MOSI1_net[0:0]}),
		  .siovref(tmpSIOVREF__MOSI1_net),
		  .interrupt({tmpINTERRUPT_0__MOSI1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MOSI1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MISO1_net;
	wire [0:0] tmpIO_0__MISO1_net;
	wire [0:0] tmpINTERRUPT_0__MISO1_net;
	electrical [0:0] tmpSIOVREF__MISO1_net;

	cy_psoc3_pins_v1_10
		#(.id("ffe262cd-c80c-435a-be99-30d3516a337e"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		MISO1
		 (.oe(tmpOE__MISO1_net),
		  .y({1'b0}),
		  .fb({Net_156}),
		  .io({tmpIO_0__MISO1_net[0:0]}),
		  .siovref(tmpSIOVREF__MISO1_net),
		  .interrupt({tmpINTERRUPT_0__MISO1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MISO1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyStatusReg_v1_90 SWITCHES (
        .status_0(Net_83),
        .status_1(Net_175),
        .status_2(1'b0),
        .status_3(1'b0),
        ...
        .intr(Net_166),
        .status_bus(8'b0));
    defparam SWITCHES.Bit0Mode = 0;
    defparam SWITCHES.Bit1Mode = 0;
    defparam SWITCHES.Bit2Mode = 0;
    defparam SWITCHES.Bit3Mode = 0;
    defparam SWITCHES.Bit4Mode = 0;
    defparam SWITCHES.Bit5Mode = 0;
    defparam SWITCHES.Bit6Mode = 0;
    defparam SWITCHES.Bit7Mode = 0;
    defparam SWITCHES.BusDisplay = 0;
    defparam SWITCHES.Interrupt = 0;
    defparam SWITCHES.MaskValue = 0;
    defparam SWITCHES.NumInputs = 2;


	cy_clock_v1_0
		#(.id("248b4e98-e0a4-4c39-936d-c85abac736d3"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__P2_net;
	wire [0:0] tmpFB_0__P2_net;
	wire [0:0] tmpIO_0__P2_net;
	wire [0:0] tmpINTERRUPT_0__P2_net;
	electrical [0:0] tmpSIOVREF__P2_net;

	cy_psoc3_pins_v1_10
		#(.id("446fbb3b-dcfb-4675-a0e4-c94ef0f8336a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P2
		 (.oe(tmpOE__P2_net),
		  .y({Net_153}),
		  .fb({tmpFB_0__P2_net[0:0]}),
		  .io({tmpIO_0__P2_net[0:0]}),
	...
	assign tmpOE__P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P1_net;
	wire [0:0] tmpFB_0__P1_net;
	wire [0:0] tmpIO_0__P1_net;
	wire [0:0] tmpINTERRUPT_0__P1_net;
	electrical [0:0] tmpSIOVREF__P1_net;

	cy_psoc3_pins_v1_10
		#(.id("93de12ce-1e09-4fff-bfc6-a7a3f6f3e132"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P1
		 (.oe(tmpOE__P1_net),
		  .y({Net_149}),
		  .fb({tmpFB_0__P1_net[0:0]}),
		  .io({tmpIO_0__P1_net[0:0]}),
		  .siovref(tmpSIOVREF__P1_net),
		  .interrupt({tmpINTERRUPT_0__P1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P3_net;
	wire [0:0] tmpFB_0__P3_net;
	wire [0:0] tmpIO_0__P3_net;
	wire [0:0] tmpINTERRUPT_0__P3_net;
	electrical [0:0] tmpSIOVREF__P3_net;

	cy_psoc3_pins_v1_10
		#(.id("4f796b55-06dd-49e0-8899-1ae9cffcfd0c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P3
		 (.oe(tmpOE__P3_net),
		  .y({Net_223}),
		  .fb({tmpFB_0__P3_net[0:0]}),
		  .io({tmpIO_0__P3_net[0:0]}),
		  .siovref(tmpSIOVREF__P3_net),
		  .interrupt({tmpINTERRUPT_0__P3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P4_net;
	wire [0:0] tmpFB_0__P4_net;
	wire [0:0] tmpIO_0__P4_net;
	wire [0:0] tmpINTERRUPT_0__P4_net;
	electrical [0:0] tmpSIOVREF__P4_net;

	cy_psoc3_pins_v1_10
		#(.id("86ff6f8e-f3f1-4163-939d-b1b06b9a1a14"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P4
		 (.oe(tmpOE__P4_net),
		  .y({Net_156}),
		  .fb({tmpFB_0__P4_net[0:0]}),
		  .io({tmpIO_0__P4_net[0:0]}),
		  .siovref(tmpSIOVREF__P4_net),
		  .interrupt({tmpINTERRUPT_0__P4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SS12_net;
	wire [0:0] tmpFB_0__SS12_net;
	wire [0:0] tmpIO_0__SS12_net;
	wire [0:0] tmpINTERRUPT_0__SS12_net;
	electrical [0:0] tmpSIOVREF__SS12_net;

	cy_psoc3_pins_v1_10
		#(.id("33976c92-736e-4896-a88c-fbf5f58490f1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS12
		 (.oe(tmpOE__SS12_net),
		  .y({Net_473}),
		  .fb({tmpFB_0__SS12_net[0:0]}),
		  .io({tmpIO_0__SS12_net[0:0]}),
		  .siovref(tmpSIOVREF__SS12_net),
		  .interrupt({tmpINTERRUPT_0__SS12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 ControlRegDisp (
        .control_1(Net_460),
        .control_2(Net_446),
        .control_3(Net_447),
        .control_0(Net_466),
        ...
        .clock(1'b0),
        .reset(1'b0),
        .control_bus(Net_476[1:0]));
    defparam ControlRegDisp.Bit0Mode = 0;
    defparam ControlRegDisp.Bit1Mode = 0;
    defparam ControlRegDisp.Bit2Mode = 0;
    defparam ControlRegDisp.Bit3Mode = 0;
    defparam ControlRegDisp.Bit4Mode = 0;
    defparam ControlRegDisp.Bit5Mode = 0;
    defparam ControlRegDisp.Bit6Mode = 0;
    defparam ControlRegDisp.Bit7Mode = 0;
    defparam ControlRegDisp.BitValue = 0;
    defparam ControlRegDisp.BusDisplay = 1;
    defparam ControlRegDisp.ExtrReset = 0;
    defparam ControlRegDisp.NumOutputs = 2;

	wire [0:0] tmpOE__SS13_net;
	wire [0:0] tmpFB_0__SS13_net;
	wire [0:0] tmpIO_0__SS13_net;
	wire [0:0] tmpINTERRUPT_0__SS13_net;
	electrical [0:0] tmpSIOVREF__SS13_net;

	cy_psoc3_pins_v1_10
		#(.id("278a5aad-4c52-4fc5-a7de-da52e8b4f048"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS13
		 (.oe(tmpOE__SS13_net),
		  .y({Net_483}),
		  .fb({tmpFB_0__SS13_net[0:0]}),
		  .io({tmpIO_0__SS13_net[0:0]}),
		  .siovref(tmpSIOVREF__SS13_net),
		  .interrupt({tmpINTERRUPT_0__SS13_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS13_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SS14_net;
	wire [0:0] tmpFB_0__SS14_net;
	wire [0:0] tmpIO_0__SS14_net;
	wire [0:0] tmpINTERRUPT_0__SS14_net;
	electrical [0:0] tmpSIOVREF__SS14_net;

	cy_psoc3_pins_v1_10
		#(.id("9a47d736-2ef1-4241-b493-2bfd27f76249"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS14
		 (.oe(tmpOE__SS14_net),
		  .y({Net_480}),
		  .fb({tmpFB_0__SS14_net[0:0]}),
		  .io({tmpIO_0__SS14_net[0:0]}),
		  .siovref(tmpSIOVREF__SS14_net),
		  .interrupt({tmpINTERRUPT_0__SS14_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS14_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SS11_net;
	wire [0:0] tmpFB_0__SS11_net;
	wire [0:0] tmpIO_0__SS11_net;
	wire [0:0] tmpINTERRUPT_0__SS11_net;
	electrical [0:0] tmpSIOVREF__SS11_net;

	cy_psoc3_pins_v1_10
		#(.id("f48bd239-fede-4bcc-89d5-579bd7ee0e35"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS11
		 (.oe(tmpOE__SS11_net),
		  .y({Net_468}),
		  .fb({tmpFB_0__SS11_net[0:0]}),
		  .io({tmpIO_0__SS11_net[0:0]}),
		  .siovref(tmpSIOVREF__SS11_net),
		  .interrupt({tmpINTERRUPT_0__SS11_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- De Mux start --
    if (1)
    begin : demuxDisp
        reg  tmp__demuxDisp_0_reg;
        reg  tmp__demuxDisp_1_reg;
        reg  tmp__demuxDisp_2_reg;
        reg  tmp__demuxDisp_3_reg;
        always @(Net_459 or Net_476)
        begin
            case (Net_476[1:0])
                2'b00:
                begin
                    tmp__demuxDisp_0_reg = Net_459;
                    tmp__demuxDisp_1_reg = 1'b0;
                    tmp__demuxDisp_2_reg = 1'b0;
                    tmp__demuxDisp_3_reg = 1'b0;
                end
                2'b01:
                begin
                    tmp__demuxDisp_0_reg = 1'b0;
                    tmp__demuxDisp_1_reg = Net_459;
                    tmp__demuxDisp_2_reg = 1'b0;
                    tmp__demuxDisp_3_reg = 1'b0;
                end
                2'b10:
                ...
                begin
                    ...
                    tmp__demuxDisp_1_reg = 1'b0;
                    tmp__demuxDisp_2_reg = 1'b0;
                    tmp__demuxDisp_3_reg = Net_459;
                end
            endcase
        end
        assign Net_455 = tmp__demuxDisp_0_reg;
        assign Net_456 = tmp__demuxDisp_1_reg;
        assign Net_486 = tmp__demuxDisp_2_reg;
        assign Net_485 = tmp__demuxDisp_3_reg;
    end
    // -- De Mux end --


    assign Net_468 = ~Net_455;


    assign Net_473 = ~Net_456;


    assign Net_483 = ~Net_486;


    assign Net_480 = ~Net_485;


    assign Net_459 = ~Net_223;
